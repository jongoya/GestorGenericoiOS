...
class CloudDatabaseHelper: NSObject {
    ...
    func parseCloudCLientObjectToLocalCLientObject(record: CKRecord) -> ClientModel {
        ...
        cliente.fechaNotificacionPersonalizada = record.object(forKey: "CD_notificacionPersonalizada") as! Int64
    ...
    func parseCloudServicioObjectToLocalServicioObject(record: CKRecord) -> ServiceModel {
        ...
        servicio.empleadoId = record.object(forKey: "CD_profesional") as! Int64
        servicio.servicios = record.object(forKey: "CD_servicios") as! [Int64]
        servicio.observaciones = record.object(forKey: "CD_observacion") as! String
        servicio.precio = record.object(forKey: "CD_precio") as? Double ?? 0.0
        //servicio.comercioId = record.object(forKey: "CD_nombre") as! String
        //servicio.isEfectivo = record.object(forKey: "CD_apellidos") as! String
    ...
    func setClientCKRecordVariables(client: ClientModel, record: CKRecord) {
        ...
        record.setValue(client.fechaNotificacionPersonalizada, forKey: "CD_notificacionPersonalizada")
