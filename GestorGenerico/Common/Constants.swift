...
class Constants: NSObject {
    ...
    static let preferencesComercioIdKey: String = "comercioId";
    static let preferencesLoginBackgroundKey: String = "background";
    static let preferencesLoginIconoKey: String = "icono";
    static let preferencesLoginPrimaryTextColorKey: String = "primaryText";
    static let preferencesLoginSecondaryTextColorKey: String = "secondaryText";
    static let preferencesLoginPrimaryColorKey: String = "primaryColor";
    static let preferencesLoginNombreAppKey: String = "nombreApp";
