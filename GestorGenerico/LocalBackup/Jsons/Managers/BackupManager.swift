...
class BackupManager: NSObject {
    ...
    static func buildBackupJson() {
        ...
        for service in servicios {
            let dictionary: [String : Any] = ["clientId" : service.clientId, "serviceId" : service.serviceId, "comercioId" : service.comercioId, "isEfectivo" : service.isEfectivo, "fecha" : service.fecha, "empleadoId" : service.empleadoId, "servicios" : service.servicios, "observaciones" : service.observaciones]
