...
class ClientesJsonManager {
    ...
    private static func createAppModelsFromJsonClientes(jsonClientes: [JsonClienteModel]) {
        ...
        for jsonCliente in jsonClientes {
            ...
            servicio.empleadoId = 651154318// Erregue
            servicio.fecha = jsonCliente.Fecha != nil ? convertFechaToTimeStamp(fecha: jsonCliente.Fecha!) : 0
            servicio.servicios = jsonCliente.Servicio != nil ? getServiceIdFromString(servicio: jsonCliente.Servicio!) : []
            servicio.observaciones = jsonCliente.Servicio != nil ? jsonCliente.Servicio! :  ""
            ...
            if jsonCliente.Servicio2 != nil {
                ...
                servicio2.empleadoId = 651154318//Erregue
                servicio2.fecha = convertFechaToTimeStamp(fecha: jsonCliente.Fecha2!)
                servicio2.servicios = getServiceIdFromString(servicio: jsonCliente.Servicio2!)
                servicio2.observaciones = jsonCliente.Servicio2!
